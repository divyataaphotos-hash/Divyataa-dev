  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 sm:px-6 md:px-8 text-center">
        ...
        >
          {/* Main Title */}
          <h1 className="text-lg sm:text-2xl md:text-4xl lg:text-5xl font-serif text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.6)] leading-none font-bold whitespace-nowrap">
