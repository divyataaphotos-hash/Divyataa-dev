    ...
    >
      ...
      <section className="py-8 md:py-12 px-6 bg-white relative">
        <div className="max-w-7xl mx-auto">
          ...
          <h2
  className="font-gayathri text-slate-900 font-bold text-center leading-tight text-1xl md:text-2xl lg:text-3xl"
>
...
<br></br>
            ...
            >
              <div className="flex flex-col h-full">
                <div className="flex flex-col md:flex-row gap-8 mb-8 items-center md:items-start">
                  <div className="w-32 h-32 md:w-48 md:h-48 rounded-2xl shrink-0 overflow-hidden shadow-xl">
  <img
    src={founderImg}
    alt="Gi. Sudakar"
    className="w-full h-full object-cover"
  ...
  <span
    key={i}
    title={q.full}
    className="px-3 py-1.5 bg-white rounded-xl text-[10px] md:text-xs text-slate-700 font-bold border border-purple-100 shadow-sm uppercase tracking-tighter cursor-help hover:bg-purple-50 transition-colors"
  >
    {q.short}
  </span>
))}
  ...
  {['Wisdom', 'Integrity', 'Compassion'].map((word) => (
    <div key={word} className="text-center group">
      <p className="text-white font-gayathri text-xl md:text-4xl mb-2 group-hover:text-purple-400 transition-colors">
        {word}
      </p>
