...
import Image from '../Website/Gallery Page/Field trip/d0ac7f28-d4a3-437d-8dd2-7ba1a6f9837d.jpg';
...
const Contact = () => {
  ...
  const contactDetails = [
    {
      ...
      content: '+91 97511 12300   ·   +91 84284 12300',
    },
    {
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-purple-100">
      ...
      {/* ─── Hero Section ─── */}
<section className="relative pt-50 pb-16 px-6 overflow-hidden bg-slate-50 border-b border-slate-100">
...
<div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
    ...
    >
            We'd love to meet your family<br className="hidden md:block" /> 
          </motion.h1>
          <motion.p
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.2 }}
      className="text-lg md:text-xl text-slate-200 max-w-4xl mx-auto leading-relaxed font-normal text-justify md:text-center"
    >
...
<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">          
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-bold text-black uppercase tracking-wider">Parent / Guardian Name *</label>
                          <input
                            required
                            name="parent_name"
                            type="text"
                            placeholder="Your full name"
                            className="w-full px-0 py-3 bg-transparent border-b-2 border-slate-200 focus:border-purple-500 outline-none transition-all duration-300 placeholder:text-purple-300 text-lg"
                          />
                        </div>
                        {/* Child Name */}
                        <div className="space-y-2">
                          <label className="text-sm font-bold text-black uppercase tracking-wider">Child's Name *</label>
                          <input 
                            required
                            name="child_name"
                            type="text" 
  ...
  className="w-full px-0 py-3 bg-transparent border-b-2 border-slate-200 focus:border-purple-500 outline-none transition-all duration-300 placeholder:text-purple-300 text-lg"
                        ...
                        {/* Child Age */}
                        <div className="space-y-2">
                          <label className="text-sm font-bold text-black uppercase tracking-wider">Child's Age *</label>
                          <input 
                            required
                            name="child_age"
                            type="number" 
  ...
  className="w-full px-0 py-3 bg-transparent border-b-2 border-slate-200 focus:border-purple-500 outline-none transition-all duration-300 placeholder:text-purple-300 text-lg"
                      ...
                      {/* Email */}
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-black uppercase tracking-wider">Email Address (optional)</label>
                        <input 
                          name="email"
                          type="email" 
  ...
  className="w-full px-0 py-3 bg-transparent border-b-2 border-slate-200 focus:border-purple-500 outline-none transition-all duration-300 placeholder:text-purple-300 text-lg"
                      ...
                      {/* Programme Dropdown */}
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-black uppercase tracking-wider">Programme of Interest *</label>
                        <select 
                          required
                          name="programme"
                      ...
                      {/* Source Dropdown */}
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-black uppercase tracking-wider">How did you hear about us? *</label>
                        <select 
                          required
                      ...
                      {/* Message */}
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-black uppercase tracking-wider">Message (optional)</label>
                        <textarea 
                          name="message"
                          rows="3"
...
<div className="lg:col-span-5">
  <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 border border-slate-100 h-full flex flex-col">

    <h2 className="text-2xl font-serif font-bold text-slate-900 mb-10">
      Contact Details
    </h2>
    ...
    <div className="space-y-10">
      {contactDetails.map((detail, idx) => (
       ...
       <div className="mt-10 rounded-[2rem] overflow-hidden shadow-lg border border-slate-100 h-[372px] relative">
      <iframe
