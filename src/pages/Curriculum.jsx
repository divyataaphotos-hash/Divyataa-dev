...
import whyMontessoriImg from '../assets/class1.JPG';
...
import elementaryCuriosityImg from '../assets/study.JPG';
...
import heroBg from '../Website/Gallery Page/Events & Festivals/IMG_4317.JPG';
import beyondClassroomBg from '../assets/silambam.webp';
...
<section className="relative pt-40 pb-12 px-6 overflow-hidden border-b border-slate-100">
  ...
  <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        className="inline-block px-4 py-1.5 rounded-full bg-purple-50 text-purple-600 font-bold uppercase tracking-widest mb-8"
          >
        Curriculum
      </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-24 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 leading-relaxed space-y-4 text-justify">
                Most of us attended schools where the teacher talked and we listened. Where the bell decided when thinking stopped. Where being wrong was something to hide, and curiosity was something to manage. The classroom moved at one pace, and every child was expected to keep up, regardless of where they truly were. <br></br>Montessori Method is built on a different understanding entirely. That children are born with a deep, natural drive to learn. That the environment matters as much as the teacher. That mastery comes through doing, through repetition chosen freely, through the particular joy of figuring something out for yourself. This method has been working across cultures, continents, and generations for more than 120 years. It endures because it begins with the child, and it trusts what it finds there.
                <br /><br />
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {principles.map((principle, index) => (
              ...
              >
                <span className="text-4xl font-gayathri text-purple-200 group-hover:text-purple-500 transition-colors duration-500 block mb-6">{principle.id}</span>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-xl md:text-3xl font-gayathri mb-6 font-bold">Primary Montessori: Casa</h2>
...
/>              </div>
            ...
            <h2 className="text-xl md:text-3xl font-serif text-slate-900 font-bold leading-tight mb-6">                Elementary: Curiosity Unleashed
              </h2>
  ...
  <div
    ...
    style={{
      backgroundImage: `url(${beyondClassroomBg})`,
    }}
  />
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-xl md:text-3xl font-serif text-white mb-6 font-bold">Beyond the Classroom</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-white/90 backdrop-blur-md p-10 rounded-[2.5rem] shadow-xl border border-white/20"
              >
      ...
      <section className="py-15 px-6 bg-white relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.div
            variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
          >
            <h2 className="text-xl md:text-3xl font-serif text-black font-bold leading-tight">
              Take the first step
            </h2>
